...
- The agent SHALL NOT execute any tool or skill not listed in the approved registry.
...
- New skills require explicit owner approval before use.
- Built-in skills (web_search, web_fetch) are pre-approved.
- The owner may ban any skill at any time via /ban command.
- Banned skills cannot be re-approved without owner action.
